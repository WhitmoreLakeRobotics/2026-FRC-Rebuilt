...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    NamedCommands.registerCommand("FStop", new SetTarget(0.0));
    ...
    SmartDashboard.putData("Start Flywheels", new SetTarget(4000.0));
    SmartDashboard.putData("Stop Flywheels", new SetTarget(0.0));
  ...
  private void configureButtonBindings() {
    ...
    A_Drive.onTrue(new SetTarget(3700.0));
