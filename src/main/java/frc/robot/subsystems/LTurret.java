...
public class LTurret extends SubsystemBase {
    ...
    private LinearCalc angleCalc = new LinearCalc();
    ...
    */
    ...
    turningMotor = new SparkMax(CanIds.MOTORS.TURN_MOTOR.canId, MotorType.kBrushless);
        configTurningMotor();
    ...
    private void configTurningMotor() {
        ...
        absEncConfig.zeroOffset(0.94238925); // this needs to be set to the offset where the turret is "zeroed"
