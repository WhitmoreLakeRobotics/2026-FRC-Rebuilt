 ...
 *
 */
public class Intake extends SubsystemBase implements PIDTunable {
    ...
    */
    ...
    private void configintakeMotor() {
        ...
        // intakeConfig.closedLoop.maxMotion.maxVelocity(5000,
        // rTowerR_CLOSED_LOOP_SLOT_DOWN);
        ...
        // intakeConfig.closedLoop.maxMotion.maxAcceleration(5000,
        // rTowerR_CLOSED_LOOP_SLOT_UP);
        // intakeConfig.closedLoop.maxMotion.maxVelocity(2000,
        // rTowerR_CLOSED_LOOP_SLOT_UP);
        // intakeConfig.closedLoop.maxMotion.allowedClosedLoopError(rTowerRPosTol,
        // rTowerR_CLOSED_LOOP_SLOT_UP);
        // intakeConfig.closedLoop.pidf(0.4, 0.0, 0.0, 0.0,
        // rTowerR_CLOSED_LOOP_SLOT_UP);

        intakeConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder);

        // intakeConfig.smartCurrentLimit(40);
        intakeConfig.smartCurrentLimit(40, 70);
    ...
    private void configextendMotor() {
        ...
        // extendConfig.closedLoop.maxMotion.cruiseVelocity(4000000,
        //// IntakeClosedLoopSlotDown);
    ...
    public enum STATUS {
        ...
        EXTENDING(15.1, 0.0),
        EXTENDED_INTAKING(15.1, 4800),        // used to be 4257
        EXTENDED_OUTPUT(15.1, -4257);         // used to be 15.1
    ...
    public String getTunableName() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getTunableName'");
    }
