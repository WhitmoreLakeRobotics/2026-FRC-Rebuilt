...
import frc.robot.subsystems.LFlywheels.FlywheelStatus;
...
public class Hopper extends SubsystemBase {
    ...
    private SparkMax transitionMotor = new SparkMax(CanIds.MOTORS.TRANSITION_MOTOR.canId, MotorType.kBrushless);
    ...
    private SparkMaxConfig transitionMotorConfig = new SparkMaxConfig();
    ...
    */
    ...
    private void configBeltMotor() {
        ...
        // beltMotorConfig.closedLoop.maxMotion.maxVelocity(5000,
        // beltMotor_CLOSED_LOOP_SLOT_DOWN);
        // beltMotorConfig.closedLoop.maxMotion.allowedClosedLoopError(beltMotorPosTol,
        // beltMotor_CLOSED_LOOP_SLOT_DOWN);
        // beltMotorConfig.closedLoop.pidf(0.4, 0.0, 0.0, 0.0,
        // beltMotor_CLOSED_LOOP_SLOT_DOWN);

        // //// Up / in Velocity Values
        // beltMotorConfig.closedLoop.maxMotion.maxAcceleration(5000,
        // beltMotor_CLOSED_LOOP_SLOT_UP);
        // beltMotorConfig.closedLoop.maxMotion.maxVelocity(2000,
        // beltMotor_CLOSED_LOOP_SLOT_UP);
        // beltMotorConfig.closedLoop.maxMotion.allowedClosedLoopError(beltMotorPosTol,
        // beltMotor_CLOSED_LOOP_SLOT_UP);
        // beltMotorConfig.closedLoop.pidf(0.4, 0.0, 0.0, 0.0,
        ...
        beltMotorConfig.smartCurrentLimit(40);
        // beltMotorConfig.smartCurrentLimit(normalStallCurrentLimit,
    ...
    private void configTransitionMotor() {
        ...
        transitionMotor.configure(transitionMotorConfig, ResetMode.kResetSafeParameters,
    ...
    private void configFunnelMotor() {
        ...
        //// Down / outVelocity Values
        // FunnelConfig.closedLoop.maxMotion.maxAcceleration(5000,
        //// rFunnelMotor_CLOSED_LOOP_SLOT_DOWN);
        // FunnelConfig.closedLoop.maxMotion.maxVelocity(5000,
        //// rFunnelMotor_CLOSED_LOOP_SLOT_DOWN);
        // FunnelConfig.closedLoop.maxMotion.allowedClosedLoopError(rFunnelMotorPosTol,
        //// rFunnelMotor_CLOSED_LOOP_SLOT_DOWN);
        // FunnelConfig.closedLoop.pidf(0.4, 0.0, 0.0, 0.0,
        //// rFunnelMotor_CLOSED_LOOP_SLOT_DOWN);

        // //// Up / in Velocity Values
        // FunnelConfig.closedLoop.maxMotion.maxAcceleration(5000,
        // rFunnelMotor_CLOSED_LOOP_SLOT_UP);
        // FunnelConfig.closedLoop.maxMotion.maxVelocity(2000,
        // rFunnelMotor_CLOSED_LOOP_SLOT_UP);
        // FunnelConfig.closedLoop.maxMotion.allowedClosedLoopError(rFunnelMotorPosTol,
        // rFunnelMotor_CLOSED_LOOP_SLOT_UP);
        // FunnelConfig.closedLoop.pidf(0.4, 0.0, 0.0, 0.0,
        ...
        // FunnelConfig.smartCurrentLimit(normalStallCurrentLimit,
        // normalFreeCurrentLimit);
