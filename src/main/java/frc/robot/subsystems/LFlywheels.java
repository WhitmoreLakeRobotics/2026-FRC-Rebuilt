...
public class LFlywheels extends SubsystemBase {
    ...
    */
    public LFlywheels(int TowerMotorR_canid, int TowerMotorL_canid) {
        ...
        configrTowerMotor(TowerRM, true);
        configrTowerMotor(TowerLM, false);
    ...
    private void configrTowerMotor(SparkMax motor, boolean Inverted) {
      ...
      //  TowerConfig.closedLoopRampRate(0.15);
       TowerConfig.voltageCompensation(12.0);
       // TowerConfig.closedLoop.maxMotion.cruiseVelocity(0);
        //TowerConfig.closedLoop.maxMotion.maxAcceleration(0);
        TowerConfig.closedLoop.pid(0.00033, 0.0, 0.0, ClosedLoopSlot.kSlot0);
        TowerConfig.closedLoop.feedForward.kV(0.0018);
    ...
    private void configrRTowerMotor(SparkMax motor) {
