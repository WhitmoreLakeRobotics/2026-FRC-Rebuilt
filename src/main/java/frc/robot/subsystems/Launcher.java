    ...
    */
    ...
    public void periodic() {
        ...
        if(bActive){
            ...
            //need to create method to calc distance to  target
    ...
    public enum KnownTargets {
        RED_HUB("Red Hub", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Hub"),
        BLUE_HUB("Blue Hub", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Hub"),
        RED_DEPOT("Red Depot", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Depot"),
        BLUE_DEPOT("Blue Depot", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Depot"),
        RED_OUTPOST("Red Outpost", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Outpost"),
        BLUE_OUTPOST("Blue Outpost", new edu.wpi.first.math.geometry.Pose2d(16.54, 1.22, new edu.wpi.first.math.geometry.Rotation2d(0)), "Outpost");
