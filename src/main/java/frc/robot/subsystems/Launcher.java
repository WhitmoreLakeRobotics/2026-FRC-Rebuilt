...
public class Launcher extends SubsystemBase {
    ...
    */
    public Launcher() {
        ...
        LFlywheels flywheels_LH = new LFlywheels(CanIds.MOTORS.TOWER1_MOTOR_RIGHT.canId,
                CanIds.MOTORS.TOWER1_MOTOR_LEFT.canId);
        LFlywheels flywheels_RH = new LFlywheels(CanIds.MOTORS.TOWER2_MOTOR_RIGHT.canId,
